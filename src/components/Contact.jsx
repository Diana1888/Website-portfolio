...
const Contact = () => {
  return (
    <div id="contact" className="h-screen py-20 px-96">
      ...
      <div className="w-full h-full my-auto flex lg:flex-col items-center justify-between lg:justify-center gap-x-0 gap-y-20">
        <motion.div
        ...
        >
          ...
          <input
            type="submit"
            className="w-full border border-yellow-500 rounded-md bg-yellow-600 px-4 py-2 text-sm tracking-wider font-light text-white outline-none hover:bg-yellow-500 transition-colors cursor-pointer"
            value="Send Message"
          />
        </motion.form>
      </div>
